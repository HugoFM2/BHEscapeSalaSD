...
class debug(object):
    ...
    def mcp23017debug():
        ...
        mcp.setup(1, mcp.GPB, mcp.IN, mcp.ADDRESS1)
        mcp.setup(2, mcp.GPB, mcp.OUT, mcp.ADDRESS1)
        mcp.setup(3, mcp.GPB, mcp.OUT, mcp.ADDRESS1)
        mcp.setup(4, mcp.GPB, mcp.IN, mcp.ADDRESS1)
        mcp.setup(5, mcp.GPB, mcp.IN, mcp.ADDRESS1)
        mcp.setup(6, mcp.GPB, mcp.IN, mcp.ADDRESS1)
        mcp.setup(7, mcp.GPB, mcp.IN, mcp.ADDRESS1)
